    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      ...
      <div className="flex items-center justify-between bg-white shadow-md rounded-lg p-6 space-x-4">
        ...
        <div className="flex flex-col items-center justify-center p-4">
          <img src="/src/assets/logo.png" alt="Logo" className="w-full h-auto max-w-xs md:max-w-md" />
          <p className="mt-4 text-center text-lg font-bold">Vasantdada Patil College of Engineering & Visual Arts</p>
        </div>

        {/* Registration form */}
        <div className="max-w-lg w-full space-y-4">
          <h2 className="text-2xl font-bold text-center text-blue-900">REGISTRATION FORM</h2>
